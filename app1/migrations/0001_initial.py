    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_classrooms', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Classroom_Requests',
            fields=[
                ...
                ('classroom_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.classrooms')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
            fields=[
                ...
                ('midday_status', models.CharField(choices=[('present', 'Present'), ('absent', 'Absent')], max_length=10)),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('classroom_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.classrooms')),
            ],
        ),
